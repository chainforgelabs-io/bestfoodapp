 ...
 * Keep in sync with frontend/src/utils/rankingSlugs.js
 */
...
function slugForValue(value, kind = "food") {
...
function headingForBoard(board, cityName) {
